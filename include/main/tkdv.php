...
<div class="col-sm-12 col-md-12 col-lg-12">
    <p class="tdmuctin"><span class="glyphicon glyphicon-th"></span> Thống kê cán bộ theo đơn vị</p>
    <form action="index.php?tab=tkdv" method="POST" role="form" class="form-horizontal">
...
if(isset($_POST["taidulieu"])){
    ...
    <?php 
        ...
        benhnhan.chucvu = chucvu.id where benhnhan.id >0";
    ...
    <div class="col-sm-10 text-right margin-top-5 margin-bottom-5">
        ...
        <a class="btn btn-sm btn-info" onclick = "window.open('inthongkedv.php?nam=<?php echo $nam;?>&donvi=<?php echo $donvi;?>', 'windowChild', 'width=1200, height=800, top=30px, left=75px')" ><i class="glyphicon glyphicon-print"></i> In phiếu khám</a>
